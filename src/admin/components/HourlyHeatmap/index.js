...
import {
  ...
  buildHourlyHeatmapData,
  DEFAULT_HEATMAP_THEME_COLOR,
  formatHourlyHeatmapHour,
  getHourlyHeatmapEmptyLabel,
  ...
  if (!hourlyAvailable) {
    return (
      <Notice status="info" isDismissible={false}>
        {unavailableLabel ||
          getHourlyHeatmapEmptyLabel(source, hourlyUnavailableReason)}
      </Notice>
    );
  }
    ...
    <div className="bbpa-hourly-heatmap">
      <ChartFrame height={HEATMAP_HEIGHT} ariaLabel={resolvedAriaLabel}>
        <ResponsiveHeatMapCanvas
          ...
          labelTextColor={(cell) => getHeatmapLabelTextColor(cell?.color)}
          axisTop={null}
          axisRight={null}
          axisBottom={{
            tickSize: 0,
              ...
              <div className="bbpa-world-map__tooltip bbpa-hourly-heatmap__tooltip">
                ...
                <div className="bbpa-world-map__tooltip-value">
                  <span
                    ...
                    style={{
                      background: cell?.color || heatmapThemeColor,
                    }}
                  />

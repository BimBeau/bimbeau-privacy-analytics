...
= 8.45.118 =
* Protect Pro event definitions from general settings and retention writes, require explicit dedicated-route replacement, and verify the complete Premium REST bootstrap chain.
